...
public class WeatherAPICelsius : MonoBehaviour
{
    public GameObject weatherTextObject2;
        // add your personal API key after APPID= and before &units=
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=34.66811&lon=135.43058&APPID=7ed88b3a92b4b9502188358afdba92c6&units=metric";

   
    void Start()
    {

    // wait a couple seconds to start and then refresh every 600 seconds (10 minutes)
